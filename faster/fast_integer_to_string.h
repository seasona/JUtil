/**
 * @file fast_integer_to_string.h
 * @author ji jie (396438446@qq.com)
 * @brief Andrei alexandrescu present the faster algorithm for transform integer
 * to string, because divide is really slow, so instead divide every digit, the
 * algorithm choose divide every two digits and find char in array. it's speed
 * is twice of normal method and fifth of std::to_string()
 * @version 0.1
 * @date 2019-11-17
 *
